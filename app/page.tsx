...
export default function Home() {
  ...
  // Mounted flag to prevent Next.js server-side hydration mismatch
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#0a081a] relative overflow-hidden font-sans p-6">
      ...
      <div className="w-full max-w-md bg-[#110e2e]/80 border border-[#231e5e]/80 backdrop-blur-xl rounded-3xl p-8 shadow-2xl relative z-10 space-y-6">
        ...
        <div className="text-center space-y-3">
          ...
          <div>
            ...
            <p className="text-xs text-slate-400 mt-1.5">
              {isRegistering ? 'Create your smart account to get started' : 'Sign in to access your customized timeline'}
            </p>
          </div>
        </div>
        ...
        {/* Auth Error Toast */}
        {errorMsg && (
          <div className="p-3 bg-rose-500/10 border border-rose-500/20 text-rose-300 text-xs font-semibold rounded-xl text-center">
            {errorMsg}
          </div>
        )}
