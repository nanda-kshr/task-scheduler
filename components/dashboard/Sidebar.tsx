    ...
    <aside className="w-72 bg-[#110e2e] text-slate-300 flex flex-col h-full flex-shrink-0 z-30 shadow-2xl relative border-r border-[#1e1a4a]">
      ...
      <div className="p-6 flex items-center justify-between border-b border-[#1e1a4a]">
        <div className="flex items-center space-x-3">
          <div className="bg-indigo-600 p-2 rounded-xl text-white shadow-lg shadow-indigo-600/30 flex items-center justify-center">
        ...
        <button className="lg:hidden text-slate-400 hover:text-white transition">
            ...
            <button
              ...
              className={`w-full flex items-center justify-between px-4 py-3.5 rounded-xl font-medium text-sm transition-all duration-200 group ${
                isActive
                  ...
                  : 'hover:bg-[#1a1740] hover:text-white text-slate-400'
              }`}
            >
              ...
              {item.badge && (
                <span className="bg-indigo-500/20 text-indigo-300 text-[10px] uppercase font-bold tracking-wider px-2 py-0.5 rounded-full">
                  AI
                </span>
              )}
            </button>
      ...
      {/* Auto-Reschedule Switch & AI mascot */}
      <div className="p-4 border-t border-[#1e1a4a] bg-[#0c0924] space-y-4">
        ...
        <div className="flex items-center justify-between px-2 py-1">
          <div className="flex flex-col">
            ...
            <span className="text-[10px] text-slate-500">AI auto-manages timeline</span>
          </div>
          <button
            onClick={onToggleAutoReschedule}
            className={`w-11 h-6 flex items-center rounded-full p-0.5 transition-all duration-300 ${
              autoReschedule ? 'bg-indigo-600 justify-end' : 'bg-slate-700 justify-start'
            }`}
          >
        ...
        <div className="bg-[#15113d] border border-[#231e5e] rounded-2xl p-4 flex flex-col items-center justify-center relative overflow-hidden shadow-inner group">
          ...
          <div className="text-center mt-3 z-10">
            ...
            <p className="text-[10px] text-slate-400 mt-1 max-w-[170px] leading-relaxed">
              {autoReschedule 
                ? "Analyzing behavior to auto-optimize targets..."
                : "Idle. Switch on to auto-pilot your tasks."
              }
            </p>
          </div>
